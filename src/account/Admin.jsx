...
const Login = () => {
    ...
    useEffect(() => {
        ...
        if (token && email && loginDate && email && userId) {
            ...
            navigate("http://145.24.223.48/developer", { replace: true });
        } else {
            console.warn("Ongeldige logingegevens, redirect naar externe site...");
            window.location.href = "https://cmgt.hr.nl/chat-login/handle/tle2-1?redirect=http://145.24.223.48/developer";
        }
    }, [location, navigate]);
