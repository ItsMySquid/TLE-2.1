...
function Results() {
    const words = [
        { word: "Hoe", color: "bg-gray-200" },
        { word: "Hoelang", color: "bg-gray-200" },
        { word: "Hoeveel", color: "bg-gray-200" },
        { word: "Waarom", color: "bg-gray-200" },
        { word: "Wanneer", color: "bg-gray-200" },
        { word: "Wat", color: "bg-gray-200" },
        { word: "Welke", color: "bg-gray-200" },
        { word: "Wie", color: "bg-gray-200" },
        { word: "Waar", color: "bg-gray-200" },
        { word: "Algemeen vraaggebaar", color: "bg-gray-200" }
    ];
